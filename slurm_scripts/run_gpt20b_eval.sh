...
#SBATCH --time=12:00:00               # Set a 6-hour time limit
...
# Run the full evaluation using the gpt-oss-20b model.
...
python main.py evaluate \
  ...
  --hashing-context "5" \
  --output-dir "evaluation_results/finaL_et_sweep_results_at_d2.5" \
  --max-new-tokens 4096
