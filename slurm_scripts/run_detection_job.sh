...
echo "Starting the detection-only job..."
cd $SLURM_SUBMIT_DIR

# Run the detection on the existing directory.
# Ensure the parameters match what you used for generation.
python run_detection_only.py evaluation_results/d2.5_et3.0_hc5 --model gpt-oss-20b
